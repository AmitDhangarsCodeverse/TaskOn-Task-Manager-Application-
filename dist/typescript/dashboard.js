...
const tasks = [
    {
        ...
        taskduedate: "2012-12-20",
    },
    {
        id: 2,
        tasktitle: "Complete Research report",
        taskduedate: "2027-09-19",
    },
];
let tasksByuser = [];
window.addEventListener("load", () => {
    ...
    tasksByuser.push(tasks[1]);
    tasksByuser.push(tasks[2]);
    tasksByuser.forEach((tasks) => {
        const task = document.createElement("div");
        task.classList.add("task");
        task.innerHTML = `<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrSLox2ia0u9peaoS7Sy19T60CQ4tO8JT46Q&s"><img>
                <p>${tasks.tasktitle.slice(0, 20)}</p>
